...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            view_all_recipients_perm = Permission.objects.get(codename='can_view_all_recipients', content_type=ct_recipient)
            ct_message = ContentType.objects.get_for_model(Message)
            view_all_messages_perm = Permission.objects.get(codename='can_view_all_messages', content_type=ct_message)
