...
class Recipient(models.Model):
    ...
    full_name = models.CharField(verbose_name="ФИО", help_text="ФИО получателя рассылки")
...
class Message(models.Model):
    ...
    owner = models.ForeignKey(to="users.User", on_delete=models.SET_NULL, blank=True, null=True)
